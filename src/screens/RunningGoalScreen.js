...
const styles = StyleSheet.create({
  ...
  timeLabel: { fontSize: 16, fontWeight: '700', marginHorizontal: 3, color: COLORS.textDark, fontFamily: 'RumRaisin' },
  timesX: { fontSize: 16, fontWeight: '700', marginHorizontal: 6, color: COLORS.textDark },
